...
public class SecurityUtil {
	...
	// 인증코드2 만들기(commons-lang3 디펜던시 - pom.xml : 랜덤스트링유틸스라는 클래스 사용하기 위함)
	...
	// commons-codec 디펜던시 암호 : 1234 -> yqid83716#52d-!       encode하면 암호, decode하면 복호
	...
	// 메일전송 디펜던시  - javax.mail 디펜던시와 spring-context-support 디펜던시 두가지 이용해서!
