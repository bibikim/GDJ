...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public String execute1(HttpServletRequest request, HttpServletResponse response) {  // request에 id, pw 담겨있다
		// request와 response를 선언할 수 있는 곳, 시작은 Controller 이다!!!!!!!
		String id = null;
		String pw = null;
		try {
			...
			return "당신의 id는" + id + "이고, 패스워드는 " + pw + "입니다.";
		} catch(Exception e) {
			try {
