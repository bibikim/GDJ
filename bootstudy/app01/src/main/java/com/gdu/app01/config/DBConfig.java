...
@MapperScan(basePackages = {"com.gdu.app01.mapper"}) // 이 패키지를 찾으면 mapper가 들어있따!
...
*/
@PropertySource(value = {"classpath:application.properties"})   // 2가지 이상 들어갈 수 있어서 {} , value에는 읽어들일 property 경로 적기
// 프로퍼티태그소스로 바꾸기
...
public class DBConfig {
	...
	@Value(value="${spring.datasource.driver-class-name}") // 스프링프레임워크가 지원하는 Value
