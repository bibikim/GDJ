...
SELECT
  ...
  FROM DUAL;
SELECT
       TRUNC(9999, -1)  -- 9990 (원 단위 절사) ex)보통 휴대폰 요금
     , TRUNC(9999, -2)  -- 9900 
  FROM DUAL;
...
SELECT
       CEIL(1.222 * 10) / 10    -- 1.3
     , CEIL(1.222 * 100) / 100  -- 1.23
  FROM DUAL;
SELECT
       CEIL(111 * 0.1) / 0.1    -- 120
     , CEIL(111 * 0.01) / 0.01  -- 200
  FROM DUAL;

SELECT 
       CEIL(1.111 * POWER(10, 1)) / POWER(10, 1)    -- 1.2
     , CEIL(1.111 * POWER(10, 2)) / POWER(10, 2)    -- 1.12
     , CEIL(11111 * POWER(10, -1)) / POWER(10, -1)  -- 11120 (-1 = 1/10)
     , CEIL(11111 * POWER(10, -2)) / POWER(10, -2)  -- 11200
  FROM DUAL;


-- 2. 원하는 자릿수로 내림
--    CEIL대신 FLOOR 함수를 사용하면 됨
