/*
TABLE PLAYER   (자식) - 부모: 국가, 이벤트
TABLE SCHEDULE (자식) - 부모: 국가, 이벤트
TABLE EVENT    (부모)
TABLE NATION   (부모)
*/
...
-- 외래키 추가
ALTER TABLE PLAYER
    ADD CONSTRAINT FK_PLAYER_EVENT FOREIGN KEY(E_CODE) REFERENCES EVENT(E_CODE)
        ON DELETE CASCADE;
ALTER TABLE PLAYER
    ADD CONSTRAINT FK_PLAYER_NATION FOREIGN KEY(N_CODE) REFERENCES NATION(N_CODE)
        ON DELETE CASCADE;

ALTER TABLE SCHEDULE
    ADD CONSTRAINT FK_SCHEDULE_EVENT FOREIGN KEY(E_CODE) REFERENCES EVENT(E_CODE)
        ON DELETE SET NULL;
ALTER TABLE SCHEDULE
    ADD CONSTRAINT FK_SCHEDULE_NATION FOREIGN KEY(N_CODE) REFERENCES NATION(N_CODE)
        ON DELETE SET NULL;
