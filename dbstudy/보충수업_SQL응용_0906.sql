...
--                                   STUNO(P)
-- 생성 순서 : PROFESSOR - DEPARTMENT - STUDENT
-- 삭제 순서 : STUDENT - DEPARTMENT - PROFESSOR
...
-- 학생테에서는 101 바로 지울 수 있음 ㅇㅇ
-- 학과테에서는 101인 부서가 가지고 있는 교수NO를 기억시키고 난 후에 101 제거
-- 교수테에서는 기억시킨 교수NO를 제거

-- 1) 정의
CREATE OR REPLACE PROCEDURE MY_PROC(DNO IN DEPARTMENT.DEPTNO%TYPE)
IS
    PNO PROFESSOR.PROFNO%TYPE; -- PROFNO를 저장시켜놓을 변수 PNO
BEGIN
