...
DESC USER_VIEWS;
SELECT VIEW_NAME, TEXT_LENGTH, TEXT, TYPE_TEXT_LENGTH, TYPE_TEXT, OID_TEXT_LENGTH, 
       OID_TEXT, VIEW_TYPE_OWNER, VIEW_TYPE, SUPERVIEW_NAME, EDITIONING_VIEW, READ_ONLY
  FROM USER_VIEWS;
...
SELECT E.EMP_ID, E.EMP_NAME, E.SALARY
  FROM DEPARTMNET D INNER JOIN EMPLOYEE E
    ON D_DEPT_ID = E.DEPT_ID
 WHERE DEPT_NAME = '총무부';
